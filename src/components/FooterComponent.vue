<template>
    ...
    <div class="box-opacity-footer">
        <div class="content_center">
            <ul class="link-footer">
                <li>
                    <span class="title">Work With Us</span>
                                        <a href="//www.pumpernickels.ca/career">~ Careers</a>
                    <a href="//www.pumpernickels.ca/about-us#franchise">~ Franchise FAQ</a>
                    
                </li>
                <li>
                    <span class="title">QUESTIONS?</span>
                    <a href="//www.pumpernickels.ca/location">~ Locations</a>
                    <a href="//www.pumpernickels.ca/contact-us">~ Contact Us</a>
                    <a href="//www.pumpernickels.ca/faq">~ Faq</a>
                </li>
                                <li>
                    <span class="title"><a href="//www.pumpernickels.ca/about-us">About</a></span>
                    <a href="//www.pumpernickels.ca/about-us">~ Our Story</a>
                    <a href="//www.pumpernickels.ca/about-us#people">~ Our People</a>
                    <a href="//www.pumpernickels.ca/about-us#our-partners">~ Our Partners</a>
                    <a href="//www.pumpernickels.ca/about-us#testimonials">~ Clients & Testimonials</a>
                ...
                <li class="last">
                    <span class="title">CONNECT</span>
                                        <div class="box-social">
                                                <a href="https://www.facebook.com/pumpernickelsdeli?fref=ts" target="_blank"><i class="fa fa-facebook"></i></a>
                                                                                                <a href="https://twitter.com/pumpernickels1" target="_blank"><i class="fa fa-twitter"></i></a>
                                                                                                                                                    <a href="https://www.instagram.com/pumpernickels_to/" target="_blank"><i class="fa fa-instagram"></i></a>
                                            </div>
                </li>
            </ul>
        </div>
            ...
            <div class="content_center">
                <div class="copyright">&copy;2022 Pumpernickels.ca</div>
                <img src="/images/pumpernickels_bottom_logo.png" alt=""/>
                <div class="link-footer1">
                   <!-- <a href="">Terms of Use</a>-->
                    <a href="//www.pumpernickels.ca/sitemap">Sitemap</a>
                    <a href="//www.pumpernickels.ca/privacy">Privacy Policy</a>
                </div>
            </div>
        </div>
        <div class="clear"></div>
...
.box-test .arrow-left{ float:left; margin: 15px 55px 0 0; height:32px }
.box-test .arrow-left:hover{ background-position:0px -42px}
.box-test .arrow-right{margin: 15px 0px 0 64px; float:left;width:32px; height:32px }
...
.box-social-right{  float:right; padding:20px 0px 20px 0px }
...
.p-center-footer{height:62px; font-size:12px; color:#F6C65B; font-weight:400;  width:100%; text-align:center;
   clear:both; margin-bottom:10px; font-weight:400
}
.p-center-footer img {
    height: 121px;
    margin: 0;
